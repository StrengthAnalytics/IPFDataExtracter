...
export const api = {
  ...
  async getStrengthStandards(
    ...
    for (const liftType of liftTypes) {
      ...
      standards[liftType] = {
        beginner: percentileAtRank(values, 20),
        novice: percentileAtRank(values, 35),
        intermediate: percentileAtRank(values, 50),
        advanced: percentileAtRank(values, 70),
        elite: percentileAtRank(values, 90),
